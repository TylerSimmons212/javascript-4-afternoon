...
function counterFactory(value) {
  ...
  return {
    inc: function(){start++; return start;},
    dec: function(){start--; return start;}
  };
}
...
function secretNumber() {
  ...
  return {
    addToSecret:function(num){secret+=num; return secret},
    takeAwayFromSecret:function(num){secret-=num; return secret}
  };
}
